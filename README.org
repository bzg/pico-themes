...
BARK-specific styles live in =bark/=, one file per theme:

| File           | Contents                                         |
|----------------+--------------------------------------------------|
| =bark/doric.css= | Chart palette, type badges, buttons, stripe rows |
| =bark/dsfr.css=  | Chart palette, type badges, buttons, stripe rows |
| =bark/org.css=   | Chart palette, type badges, buttons, stripe rows |
| =bark/swh.css=   | Chart palette, type badges, buttons, stripe rows |
